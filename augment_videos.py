...
def augmentVideo(annotation_dict, labels_dict, data_dir='dataset/examples/', output_dir='dataset/augmented-videos/'):
    """
    ...
    if not os.path.exists("dataset/augmented-videos"):
        os.mkdir("dataset/augmented-videos")
...
def rotateVideo(path, output_dir, video_id, degree):
    ...
    print(output_dir + video_id + "_rotate_" + str(degree) + ".mp4")
